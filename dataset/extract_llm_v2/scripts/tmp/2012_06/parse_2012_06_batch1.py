...
def parse_multi_line_row(row):
    """Splits columns by <br> and returns a list of dictionaries, one for each sub-row."""
    max_lines = 0
    for col in row:
        lines = col.split("<br>")
    ...
    for i in range(max_lines):
        ...
        for col in row:
            lines = col.split("<br>")
            if i < len(lines): sub_row.append(lines[i].strip())
            else: sub_row.append("")
        sub_rows.append(sub_row)
    return sub_rows

def parse_pl1():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_06_Phuluc_06_2012_PL1.md"
    metadata = {"year": 2012, "month": 6, "appendix_number": "PL1"}
    records = []
    t = {"year": 2012, "month": 6, "period_type": "Monthly", "report_date": "2012-06-15"}
...
def parse_pl2():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_06_Phuluc_06_2012_PL2.md"
    metadata = {"year": 2012, "month": 6, "appendix_number": "PL2"}
    records = []
    t = {"year": 2012, "month": 6, "period_type": "Monthly", "report_date": "2012-06-15"}
    rows = extract_rows(fpath)
    ...
    for row in rows:
        ...
        full_rows.extend(parse_multi_line_row(row))
    ...
    for row in full_rows:
        ...
        add(4, "Lúa", "Đông Xuân", "Yield", "ta_ha")
        add(5, "Lúa", "Mùa/Hè Thu", "Area_Planted")
...
def parse_pl3():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_06_Phuluc_06_2012_PL3.md"
    metadata = {"year": 2012, "month": 6, "appendix_number": "PL3"}
    records = []
    t = {"year": 2012, "month": 6, "period_type": "Monthly", "report_date": "2012-06-15"}
    rows = extract_rows(fpath)
...
def parse_pl4():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_06_Phuluc_06_2012_PL4.md"
    metadata = {"year": 2012, "month": 6, "appendix_number": "PL4"}
    records = []
    t = {"year": 2012, "month": 6, "period_type": "Monthly", "report_date": "2012-06-15"}
    rows = extract_rows(fpath)
    ...
    for row in full_rows:
        ...
        add(1, "Lúa", "Hè Thu", "Area_Planted")
        add(2, "Lúa", "Hè Thu", "Area_Harvested")
        add(3, "Lúa", "Mùa", "Area_Planted")
...
def parse_pl5():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_06_Phuluc_06_2012_PL5.md"
    metadata = {"year": 2012, "month": 6, "appendix_number": "PL5"}
    records = []
    t = {"year": 2012, "month": 6, "period_type": "Monthly", "report_date": "2012-06-15"}
    rows = extract_rows(fpath)
...
if __name__ == "__main__":
    ...
    save_json({"metadata": {"year": 2012, "month": 6}, "records": parse_pl1()}, os.path.join(out_dir, "2012_06_Phuluc_06_2012_PL1.json"))
    save_json({"metadata": {"year": 2012, "month": 6}, "records": parse_pl2()}, os.path.join(out_dir, "2012_06_Phuluc_06_2012_PL2.json"))
    save_json({"metadata": {"year": 2012, "month": 6}, "records": parse_pl3()}, os.path.join(out_dir, "2012_06_Phuluc_06_2012_PL3.json"))
    save_json({"metadata": {"year": 2012, "month": 6}, "records": parse_pl4()}, os.path.join(out_dir, "2012_06_Phuluc_06_2012_PL4.json"))
    save_json({"metadata": {"year": 2012, "month": 6}, "records": parse_pl5()}, os.path.join(out_dir, "2012_06_Phuluc_06_2012_PL5.json"))
    
    print("Successfully parsed Batch 1 for June 2012.")
