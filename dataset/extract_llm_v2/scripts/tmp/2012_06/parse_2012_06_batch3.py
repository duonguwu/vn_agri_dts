...
def create_record(metadata, time, loc_name, geo_level, item, metric, comp=None):
    ...
    alias_map = {
        ...
        "TVQ ARẬP THỐNG NHẤT": "United Arab Emirates", "TVQ. ARẬP THỐNG NHẤT": "United Arab Emirates",
        "ARẬP XÊÚT": "Saudi Arabia", "GANA": "Ghana", "XÊ NÊ GAN": "Senegal", "HỒNG CÔNG": "Hong Kong"
    }
...
def parse_market_file(fpath, metadata, time_context, trade_type):
    ...
    for row in rows:
        ...
        # Super row check: if row[0] is empty and row[1] has a commodity name
...
if __name__ == "__main__":
    ...
    t_5m_context = {"year": 2012, "month": 5, "period_type": "Cumulative", "report_date": "2012-05-31"}
    
    save_json({"metadata": {"year": 2012, "month": 6}, "records": parse_market_file("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_06_Phuluc_06_2012_PL10b.md", {"year": 2012, "month": 6, "appendix_number": "PL10b"}, t_5m_context, "Export")}, os.path.join(out_dir, "2012_06_Phuluc_06_2012_PL10b.json"))
    save_json({"metadata": {"year": 2012, "month": 6}, "records": parse_market_file("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_06_Phuluc_06_2012_PL10c.md", {"year": 2012, "month": 6, "appendix_number": "PL10c"}, t_5m_context, "Import")}, os.path.join(out_dir, "2012_06_Phuluc_06_2012_PL10c.json"))
    
    print("Successfully parsed Batch 3 for June 2012.")
