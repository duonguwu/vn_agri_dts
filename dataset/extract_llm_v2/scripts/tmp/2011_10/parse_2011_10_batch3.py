...
def parse_pl10():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2011/2011_10_Phuluc_10_2011_f_PL10.md"
    metadata = {"year": 2011, "month": 10, "appendix_number": "PL10", "source_file": "2011_10_Phuluc_10_2011_f_PL10.md"}
    records = []
    ...
    for row in rows:
        ...
        # 7:Qm, 8:Vm, 9:Q10, 10:V10
        qm = normalize_number(row[7])
        vm = normalize_number(row[8])
        q10 = normalize_number(row[9])
        v10 = normalize_number(row[10])
        ...
        if q10: records.append(create_record(metadata, t_10m, "Cả nước", "National", {"sector": "Trade", "commodity": name}, {"attribute": "Volume", "value": q10, "unit": "1000_ton", "data_type": "Estimate", "trade_type": curr_type}))
        if v10: records.append(create_record(metadata, t_10m, "Cả nước", "National", {"sector": "Trade", "commodity": name}, {"attribute": "Value", "value": v10, "unit": "million_USD", "data_type": "Estimate", "trade_type": curr_type}))
    return records
...
def parse_pl13():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2011/2011_10_Phuluc_10_2011_f_PL13.md"
    metadata = {"year": 2011, "month": 10, "appendix_number": "PL13", "source_file": "2011_10_Phuluc_10_2011_f_PL13.md"}
    records = []
    t_month = {"year": 2011, "month": 10, "period_type": "Monthly", "report_date": "2011-10-31"}
    t_10m = {"year": 2011, "month": 10, "period_type": "Cumulative", "report_date": "2011-10-31"}
    ...
    for row in rows:
        ...
        if v10: records.append(create_record(metadata, t_10m, "Cả nước", "National", {"sector": "Investment", "commodity": name}, {"attribute": "Investment_Amount", "value": v10, "unit": "million_VND", "data_type": "Estimate"}))
    return records
...
if __name__ == "__main__":
    ...
    save_json({"metadata": {"year": 2011, "month": 10}, "records": parse_pl10()}, os.path.join(out_dir, "2011_10_Phuluc_10_2011_f_PL10.json"))
    
    t_9m_context = {"year": 2011, "month": 9, "period_type": "Cumulative", "report_date": "2011-09-30"}
    md_pl11 = {"year": 2011, "month": 10, "appendix_number": "PL11", "source_file": "2011_10_Phuluc_10_2011_f_PL11.md"}
    save_json({"metadata": {"year": 2011, "month": 10}, "records": parse_market_file("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2011/2011_10_Phuluc_10_2011_f_PL11.md", md_pl11, t_9m_context, "Export")}, os.path.join(out_dir, "2011_10_Phuluc_10_2011_f_PL11.json"))
    
    md_pl12 = {"year": 2011, "month": 10, "appendix_number": "PL12", "source_file": "2011_10_Phuluc_10_2011_f_PL12.md"}
    save_json({"metadata": {"year": 2011, "month": 10}, "records": parse_market_file("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2011/2011_10_Phuluc_10_2011_f_PL12.md", md_pl12, t_9m_context, "Import")}, os.path.join(out_dir, "2011_10_Phuluc_10_2011_f_PL12.json"))
    
    save_json({"metadata": {"year": 2011, "month": 10}, "records": parse_pl13()}, os.path.join(out_dir, "2011_10_Phuluc_10_2011_f_PL13.json"))
    
    print("Successfully parsed Batch 3 (PL10, PL11, PL12, PL13) for October 2011.")
