...
def create_record(metadata, time, loc_name, geo_level, item, metric, comp=None):
    ...
    alias_map = {
        ...
        "Hà Gian**g**": "Hà Giang", "Cao Bng": "Cao Bằng"
    }
...
def parse_pl1():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_03_Phuluc_03_2012_PL1.md"
    metadata = {"year": 2012, "month": 3, "appendix_number": "PL1", "source_file": "2012_03_Phuluc_03_2012_PL1.md"}
    records = []
    ...
    for row in rows:
        ...
        elif "lúa hè thu" in name.lower(): item.update({"commodity": "Lúa", "sub_item": "Hè Thu"})
...
def parse_pl2():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_03_Phuluc_03_2012_PL2.md"
    metadata = {"year": 2012, "month": 3, "appendix_number": "PL2", "source_file": "2012_03_Phuluc_03_2012_PL2.md"}
    records = []
    t = {"year": 2012, "month": 3, "period_type": "Monthly", "report_date": "2012-03-15"}
    rows = extract_rows(fpath)
...
def parse_pl3():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_03_Phuluc_03_2012_PL3.md"
    metadata = {"year": 2012, "month": 3, "appendix_number": "PL3", "source_file": "2012_03_Phuluc_03_2012_PL3.md"}
    records = []
    t = {"year": 2012, "month": 3, "period_type": "Monthly", "report_date": "2012-03-15"}
    rows = extract_rows(fpath)
    ...
    for row in rows:
        ...
        name = row[0].replace("**", "").strip()
        if "Col" in name or name == "" or "Vùng/Tỉnh" in name: continue
...
def parse_pl4():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_03_Phuluc_03_2012_PL4.md"
    metadata = {"year": 2012, "month": 3, "appendix_number": "PL4", "source_file": "2012_03_Phuluc_03_2012_PL4.md"}
    records = []
    t = {"year": 2012, "month": 3, "period_type": "Monthly", "report_date": "2012-03-15"}
    rows = extract_rows(fpath)
...
if __name__ == "__main__":
    ...
    save_json({"metadata": {"year": 2012, "month": 3}, "records": parse_pl1()}, os.path.join(out_dir, "2012_03_Phuluc_03_2012_PL1.json"))
    save_json({"metadata": {"year": 2012, "month": 3}, "records": parse_pl2()}, os.path.join(out_dir, "2012_03_Phuluc_03_2012_PL2.json"))
    save_json({"metadata": {"year": 2012, "month": 3}, "records": parse_pl3()}, os.path.join(out_dir, "2012_03_Phuluc_03_2012_PL3.json"))
    save_json({"metadata": {"year": 2012, "month": 3}, "records": parse_pl4()}, os.path.join(out_dir, "2012_03_Phuluc_03_2012_PL4.json"))
    
    print("Successfully parsed Batch 1 (PL1-PL4) for March 2012.")
