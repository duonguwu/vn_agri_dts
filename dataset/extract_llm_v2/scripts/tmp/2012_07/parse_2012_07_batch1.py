...
def normalize_number(s):
    ...
    # Special handling for numbers with , that might be decimals or thousand separators
    if "." in s and "," in s:
...
def create_record(metadata, time, loc_name, geo_level, item, metric, comp=None):
    ...
    alias_map = {
        ...
        "Hà Nội (mở rộng)": "Hà Nội", "Cao Bng": "Cao Bằng"
    }
...
def parse_pl1():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_07_Phuluc_07_2012_PL1.md"
    metadata = {"year": 2012, "month": 7, "appendix_number": "PL1"}
    records = []
    t = {"year": 2012, "month": 7, "period_type": "Monthly", "report_date": "2012-07-15"}
...
def parse_pl2():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_07_Phuluc_07_2012_PL2.md"
    metadata = {"year": 2012, "month": 7, "appendix_number": "PL2"}
    records = []
    t = {"year": 2012, "month": 7, "period_type": "Monthly", "report_date": "2012-07-15"}
    rows = extract_rows(fpath)
    ...
    for row in rows:
        ...
        add(3, "Lúa", "Đông Xuân", "Yield", "ta_ha")
...
def parse_pl3():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_07_Phuluc_07_2012_PL3.md"
    metadata = {"year": 2012, "month": 7, "appendix_number": "PL3"}
    records = []
    t = {"year": 2012, "month": 7, "period_type": "Monthly", "report_date": "2012-07-15"}
    rows = extract_rows(fpath)
...
def parse_pl4():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_07_Phuluc_07_2012_PL4.md"
    metadata = {"year": 2012, "month": 7, "appendix_number": "PL4"}
    records = []
    t = {"year": 2012, "month": 7, "period_type": "Monthly", "report_date": "2012-07-15"}
    rows = extract_rows(fpath)
    ...
    for row in rows:
        ...
        def add(idx, comm, sub, attr):
            if idx >= len(row): return
            val = normalize_number(row[idx].replace("<br>", ""))
            if val is not None:
...
def parse_pl5():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_07_Phuluc_07_2012_PL5.md"
    metadata = {"year": 2012, "month": 7, "appendix_number": "PL5"}
    records = []
    t = {"year": 2012, "month": 7, "period_type": "Monthly", "report_date": "2012-07-15"}
    rows = extract_rows(fpath)
...
if __name__ == "__main__":
    ...
    save_json({"metadata": {"year": 2012, "month": 7}, "records": parse_pl1()}, os.path.join(out_dir, "2012_07_Phuluc_07_2012_PL1.json"))
    save_json({"metadata": {"year": 2012, "month": 7}, "records": parse_pl2()}, os.path.join(out_dir, "2012_07_Phuluc_07_2012_PL2.json"))
    save_json({"metadata": {"year": 2012, "month": 7}, "records": parse_pl3()}, os.path.join(out_dir, "2012_07_Phuluc_07_2012_PL3.json"))
    save_json({"metadata": {"year": 2012, "month": 7}, "records": parse_pl4()}, os.path.join(out_dir, "2012_07_Phuluc_07_2012_PL4.json"))
    save_json({"metadata": {"year": 2012, "month": 7}, "records": parse_pl5()}, os.path.join(out_dir, "2012_07_Phuluc_07_2012_PL5.json"))
    
    print("Successfully parsed Batch 1 for July 2012.")
