...
def create_record(metadata, time, loc_name, geo_level, item, metric, comp=None):
    ...
    alias_map = {
        ...
        "TIỂU VƯƠNG QUỐC ARẬP THỐNG NHẤT": "United Arab Emirates", "BỜ BIỂN NGÀ": "Ivory Coast"
    }
...
def parse_pl11a():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_05_Phuluc_05_2012_PL11a.md"
    metadata = {"year": 2012, "month": 5, "appendix_number": "PL11a"}
    records = []
    t_cm = {"year": 2012, "month": 5, "period_type": "Monthly", "report_date": "2012-05-31"}
    t_cy = {"year": 2012, "month": 5, "period_type": "Cumulative", "report_date": "2012-05-31"}
...
if __name__ == "__main__":
    out_dir = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/extracted_data/2012/05"
    os.makedirs(out_dir, exist_ok=True)
    
    save_json({"metadata": {"year": 2012, "month": 5}, "records": parse_pl11a()}, os.path.join(out_dir, "2012_05_Phuluc_05_2012_PL11a.json"))
    
    t_4m_context = {"year": 2012, "month": 4, "period_type": "Cumulative", "report_date": "2012-04-30"}
    save_json({"metadata": {"year": 2012, "month": 5}, "records": parse_market_file("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_05_Phuluc_05_2012_PL11b.md", {"year": 2012, "month": 5, "appendix_number": "PL11b"}, t_4m_context, "Export")}, os.path.join(out_dir, "2012_05_Phuluc_05_2012_PL11b.json"))
    save_json({"metadata": {"year": 2012, "month": 5}, "records": parse_market_file("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_05_Phuluc_05_2012_PL11c.md", {"year": 2012, "month": 5, "appendix_number": "PL11c"}, t_4m_context, "Import")}, os.path.join(out_dir, "2012_05_Phuluc_05_2012_PL11c.json"))
    
    print("Successfully parsed Batch 3 for May 2012.")
