...
def parse_pl9():
    fpath = "/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_11_Phuluc_11_2012_PL9.md"
    metadata = {"year": 2012, "month": 11, "appendix_number": "PL9"}
    records = []
    ...
    for row in rows:
        ...
        q11 = normalize_number(row[9]); v11 = normalize_number(row[10])
        ...
        if q11: records.append(create_record(metadata, t_11m, "Cả nước", "National", {"sector": "Trade", "commodity": name}, {"attribute": "Volume", "value": q11, "unit": "1000_ton", "data_type": "Estimate", "trade_type": curr_trade}))
        if v11: records.append(create_record(metadata, t_11m, "Cả nước", "National", {"sector": "Trade", "commodity": name}, {"attribute": "Value", "value": v11, "unit": "million_USD", "data_type": "Estimate", "trade_type": curr_trade}))
    return records
...
def parse_market_file(fpath, metadata, time_context, trade_type):
    ...
    for row in rows:
        ...
        # Check if it is a commodity summary row
        ...
        if is_summary:
            ...
            for i in range(len(names)):
                ...
                # Check if this sub-item is actually a commodity (e.g. bolded or all caps)
...
def parse_compliance(fpath, metadata):
    rows = extract_rows(fpath)
    records = []
    t = {"year": 2012, "month": 11, "period_type": "Monthly", "report_date": "2012-11-24"}
    for row in rows:
...
if __name__ == "__main__":
    ...
    save_json({"metadata": {"year": 2012, "month": 11}, "records": parse_pl9()}, os.path.join(out_dir, "2012_11_Phuluc_11_2012_PL9.json"))
    save_json({"metadata": {"year": 2012, "month": 11}, "records": parse_market_file("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_11_Phuluc_11_2012_PL10.md", {"year": 2012, "month": 11, "appendix_number": "PL10"}, t_10m, "Export")}, os.path.join(out_dir, "2012_11_Phuluc_11_2012_PL10.json"))
    save_json({"metadata": {"year": 2012, "month": 11}, "records": parse_market_file("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_11_Phuluc_11_2012_PL11.md", {"year": 2012, "month": 11, "appendix_number": "PL11"}, t_10m, "Import")}, os.path.join(out_dir, "2012_11_Phuluc_11_2012_PL11.json"))
    save_json({"metadata": {"year": 2012, "month": 11}, "records": parse_compliance("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_11_Phuluc_11_2012_PL10b.md", {"year": 2012, "month": 11, "appendix_number": "PL10b"})}, os.path.join(out_dir, "2012_11_Phuluc_11_2012_PL10b.json"))
    save_json({"metadata": {"year": 2012, "month": 11}, "records": parse_compliance("/media/duongn/New Volume/UIT/aThacSy/Data Mining/2. Data Pre-processing/vn_agri_dts/segments/2012/2012_11_Phuluc_11_2012_PL13.md", {"year": 2012, "month": 11, "appendix_number": "PL13"})}, os.path.join(out_dir, "2012_11_Phuluc_11_2012_PL13.json"))
    
    print("Successfully parsed Batch 3 for November 2012.")
